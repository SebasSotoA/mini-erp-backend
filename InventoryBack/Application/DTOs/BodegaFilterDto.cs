...
/// <summary>
/// DTO for filtering bodegas (warehouses) with search and sorting.
/// </summary>
public class BodegaFilterDto
{
    // ========== PAGINATION ==========
    ...
    /// <summary>
    /// Search by direccion (partial match, case-insensitive)
    /// </summary>
    ...
    /// <summary>
    /// Sort by field: "nombre" (default), "direccion", "fecha"
    /// </summary>
